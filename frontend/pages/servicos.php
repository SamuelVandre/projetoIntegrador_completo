...
<head>
  <!-- ==========================================
       CONFIGURAÇÕES DE CABEÇALHO (HEAD)
       Metadados, Fontes e Links de Estilo
       ========================================== -->
  <meta charset="UTF-8">
  ...
  <!-- Google Fonts: Cormorant Garamond (Serifada) e Montserrat (Sans-serif) -->
...
<body>
  ...
  <!-- Inclusão do Header Global via PHP -->
  <?php
  ...
  <!-- ------------------------------------------
       SEÇÃO HERO
       Banner principal de impacto com overlay e
       chamada para ação (CTA)
       ------------------------------------------ -->
  <section class="hero">
    <div class="hero__overlay"></div> <!-- Filtro escuro para legibilidade -->
  ...
  <!-- ------------------------------------------
       SEÇÃO INTRO
       Bloco institucional apresentando a filosofia
       de projeto do escritório
       ------------------------------------------ -->
  <section class="intro">
    <div class="intro__texto">
      <div class="intro__linha"></div> <!-- Detalhe decorativo dourado -->
    ...
    <div class="intro__imagem">
      <img src="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=700&q=80" alt="Interior sofisticado Nayara Leal">
    </div>
  </section>
  ...
  <!-- ------------------------------------------
       ...
       Grid de cards detalhando cada especialidade
       do escritório (Arquitetura, Interiores, etc)
       ------------------------------------------ -->
    ...
    <div class="servicos__grid">
      ...
      <div class="servico-card">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Projetos residenciais personalizados que unem conforto, sofisticação e funcionalidade. Desenvolvemos ambientes acolhedores e modernos, valorizando iluminação e circulação.</p>
        </div>
      </div>
      ...
      <div class="servico-card">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Criamos interiores elegantes e funcionais, alinhados à personalidade de cada cliente. Trabalhamos composição de cores, mobiliário e decoração única.</p>
        </div>
      </div>

      <!-- Card: Projetos Comerciais -->
      <div class="servico-card">
        <div class="servico-card__imagem-wrap">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Ambientes comerciais estratégicos pensados para fortalecer a marca e proporcionar conforto aos clientes e colaboradores.</p>
        </div>
      </div>
      ...
      <div class="servico-card">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Orientação profissional para reformas rápidas, escolha de materiais e paleta de cores, garantindo assertividade nas decisões.</p>
        </div>
      </div>
      ...
      <div class="servico-card">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Planejamento completo para renovação de ambientes, trazendo modernidade e valorização estética aos espaços existentes.</p>
        </div>
      </div>
      ...
      <div class="servico-card">
        ...
        <div class="servico-card__corpo">
          ...
          <p class="servico-card__descricao">Apresentação realista através de modelagem 3D, permitindo visualizar cada detalhe do projeto antes da execução final.</p>
        </div>
      </div>
  ...
  <!-- ------------------------------------------
       BANNER DESTAQUE
       Destaque secundário com frase de efeito 
       e imagem lateral
       ------------------------------------------ -->
  <section class="banner">
    <div class="banner__imagem">
      <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=700&q=80" alt="Detalhe de mobiliário único">
    </div>
    <div class="banner__texto">
      <div class="banner__linha"></div>
      <h3 class="banner__titulo">Cada projeto é único</h3>
      <p class="banner__descricao">Acreditamos que arquitetura vai além da estética. Nosso objetivo é criar ambientes que transmitam conforto e bem-estar através de soluções inteligentes.</p>
    </div>
  </section>
  ...
  <!-- ------------------------------------------
       SEÇÃO PROCESSO
       Infográfico das etapas de atendimento,
  ...
  <section class="processo">
    ...
    <div class="processo__etapas">
      ...
      <div class="etapa">
        ...
        <p class="etapa__descricao">Briefing e necessidades</p>
      </div>

      <div class="etapa__conector"></div> <!-- Linha entre ícones -->
      ...
      <div class="etapa">
        ...
        <p class="etapa__descricao">Conceito e referências</p>
      </div>
      ...
      <div class="etapa">
        ...
        <p class="etapa__descricao">Criação do projeto</p>
      </div>
      ...
      <div class="etapa">
        ...
        <p class="etapa__descricao">Apresentação 3D</p>
      </div>
      ...
      <div class="etapa">
        ...
        <p class="etapa__descricao">Entrega final</p>
      </div>
